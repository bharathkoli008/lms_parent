...
class _UPIPageState extends State<UPIPage> {
  ...
  Future<UpiResponse> initiateTransaction(UpiApp app) async {
    return _upiIndia.startTransaction(
      app: app,
      receiverUpiId: "Q24542979@ybl",
      receiverName: 'Bharath Koli',
      flexibleAmount: false,
      transactionRefId: 'TestingUpiIndiaPlugin',
      transactionNote: 'Test fees',
      amount: 1,    // merchantId: "KuYtqC27789709406425"
    );
  }
  ...
  void handleerror() async{
   if(widget.id != ''){
     await FirebaseFirestore.instance.collection('students').where('id',isEqualTo: widget.id).get(
       ...
       var paid = int.parse(snapshots.docs.first.data()['fees_paid'].toString());
       print('======================================$paid');
